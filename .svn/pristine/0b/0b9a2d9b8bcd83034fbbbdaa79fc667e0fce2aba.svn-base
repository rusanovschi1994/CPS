...
public class TableUtils {
    ...
    public static void installCopyHandler(TableView<?> table) {
        ...
        // install copy keyboard handler
        table.setOnKeyPressed(new CopyTableKeyEventHandler());

    }

    public static void installPasteHandler(TableView<?> table) {

        // install paste keyboard handler
        table.setOnKeyPressed(new PasteTableKeyEventHandler());
    ...
    public static class CopyTableKeyEventHandler implements EventHandler<KeyEvent> {
    ...
    public static class PasteTableKeyEventHandler implements EventHandler<KeyEvent> {

        KeyCodeCombination pasteKeyCodeCompination = new KeyCodeCombination(KeyCode.V, KeyCombination.CONTROL_ANY);

        public void handle(final KeyEvent keyEvent) {

            if (pasteKeyCodeCompination.match(keyEvent)) {
